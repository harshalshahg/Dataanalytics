...
```{r}
read_csv("a,b\n1,2,3\n4,5,6") # There are Only two columns that are specified in the header "a" and "b", but there are three  columns, hence the last column is dropped.

read_csv("a,b,c\n1,2\n1,2,3,4") # The numbers of columns in the data and number of columns in the header are different.
...
read_csv("a,b\n1,2\na,b", col_names = FALSE)
read_csv("a;b\n1;3") # We need to change delim to ','
