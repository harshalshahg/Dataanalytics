...
## 11.2.2 EXERCISES
 ...
 2. Apart from file, skip, and comment, what other arguments do read_csv() and read_tsv() have in common?
  ...
  Answer  col_names, col_types, locale, na, quoted_na, trim_ws, n_max, guess_max, progress
    
3. What are the most important arguments to read_fwf()?
    
  Answer  col_positions  since the function should know length of every field.
...
5. What's the difference between read_csv() and read_csv2()?
 ...
 Answer: read_csv2() uses a semicolon (;) for separators, instead of comma or period(,.). comma is common in Europena countries as they use it as decimal seperator.
